...
%>
	...
	<div>
		<span class="ml-2 mt-3" style="float:left; color:gray;"><h4>일정 글 작성</h4></span>
	</div>
	<div>
		<form method="post" action="scheduleWriteAction.jsp">
			<table class="table table" style="text-align:center; border:none solid #dddddd">
					<tr>
						<td><input type="text" class="form-control" placeholder="글 제목" name="scheduleTitle" maxlength="50"></td>
					</tr>
					<tr>
						<td>
							<p><input type="date" class="form-control" placeholder="일정" name="scheduleDate"></p>
      					</td>
					</tr>
			</table>
			<div align="center">
